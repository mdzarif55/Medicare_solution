...
const Cart = () => {
    ...
    const [selectedAddress, setSelectedShowAddress] = useState(null)
        ...
        try {
            ...
            if (data.success) {
                ...
                if (data.addresses.length > 0) {
                    setSelectedShowAddress(data.addresses[0])
                }
                else {
        ...
        <div className="flex flex-col md:flex-row mt-16">
                    ...
                    <div key={index} className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 items-center text-sm md:text-base font-medium pt-3">
                        <div className="flex items-center md:gap-6 gap-3">
                            <div className="cursor-pointer w-24 h-24 flex items-center justify-center border border-gray-300 rounded overflow-hidden">
                                <img onClick={() => { navigate(`/products/${product.category.toLowerCase()}/${product._id}`) }} className="max-w-full h-full object-cover" src={product.image[0]} alt={product.name} />
                            </div>
                            <div>
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                {addresses.map((address, index) => (<p onClick={() => { setSelectedShowAddress(address), setShowAddress(false) }} className="text-gray-500 p-2 hover:bg-gray-100">
                ...
                <div className="text-gray-500 mt-4 space-y-2">
                    ...
                    <p className="flex justify-between">
                        <span>Platform Charge (2%)</span><span>{currency}{getCartAmount() * 2 / 100}</span>
                    </p>
